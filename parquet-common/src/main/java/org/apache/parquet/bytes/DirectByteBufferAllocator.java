...
public class DirectByteBufferAllocator implements ByteBufferAllocator {
  public static DirectByteBufferAllocator getInstance() {
  ...
  public ParquetBuf allocate(final int size) {
    return ParquetBuf.fromByteBuffer(ByteBuffer.allocateDirect(size));
  }
